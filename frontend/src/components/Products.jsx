...
export default function Products({ products, activeFilter, setActiveFilter, filters, onView }) {
  return (
    <section id="products" className="mx-auto max-w-[90rem] px-3 py-20 md:px-5">
      <h2 className="text-3xl font-extrabold tracking-tight text-slate-900 liquid-text md:text-5xl">The Signature Purifier Collection</h2>
      <p className="mt-2 text-lg font-medium text-slate-600">Designed as statement pieces. Engineered as performance icons.</p>
